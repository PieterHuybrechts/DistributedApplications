...
public class ScheduledTasks {
    ...
    public void getReport(){
    	...
    	City[] cities = null;
    	try{
    		cities = restTemplate.getForObject("http://localhost:8765/destination/city", City[].class);    		
    	...
    	try{    	
    		...
    		restTemplate.exchange("http://localhost:8765/weather/report?zip="+city.getZip(), HttpMethod.POST, entity,String.class);
    	}catch(HttpClientErrorException e) {
